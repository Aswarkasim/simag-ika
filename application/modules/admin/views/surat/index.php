  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-body no-padding">
        ...
        <div class="row">
          <div class="col-md-8">
            <a href="<?= base_url('admin/surat'); ?>" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
          </div>
          <div class="col-md-4">
            <form action="<?= base_url('admin/surat/cari'); ?>" method="post">
                ...
                <tbody>
                  ...
                  <?php foreach ($surat as $row) { ?>
                    <tr>
                      ...
                      <td class="mailbox-name"><a href="<?= base_url('admin/surat/detail/' . $row->id_surat); ?>"><?= $row->instansi_asal; ?></a></td>
                      ...
                      <td><a href="<?= base_url('admin/surat/delete/' . $row->id_surat); ?>" class="tombol-hapus"><i class="fa fa-trash"></i></a></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
